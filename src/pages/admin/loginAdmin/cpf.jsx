...
export default function ({ navigation, route }, params) {
  ...
  useEffect(() => {
    ...
    onSnapshot(
      query(collection(db, "admins"), where("cpf", "==", cpf)),
      (querySnapshot) => {
        const cd = [];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Pressable onPress={() => navigation.navigate("registerAdmin")}>
          <Text style={styles.textRegisterAccount}>cadastrar conta admin</Text>
        </Pressable>
        <Button
          style={styles.button}
          ...
          onPress={() =>
            navigation.navigate("passwordLoginUser", {
              email: email,
            })
          }
        >
